...
vu.telemetry.initialize = function() {
    ...
    vu.sop.logApi = window.vu.sop.logApi || {};
    vu.face.ui.gestures = window.vu.face.ui.gestures || {};
}
      ...
      if (existingStartEventIndex !== -1) {
          ...
          if(telemetryStartEvent[existingStartEventIndex].activity === "SelfieActivityProcess"){
             ...
             if(eventData.captureResponseNumber !== vu.telemetry.captureResponseCode.SELFIE.SELFIE_SUCCESS){
                 ...
                 captureSelfieSaveBody = { "minimumValidGestures" : vu.face.ui.gestures.getNumOfChallenges(),
                     "validGestures": gestureFeedback.length,
                     "invalidGestures": vu.face.ui.gestures.getNumOfChallenges() - gestureFeedback.length ,
                     "passedTest" : false,
                 ...
                 captureSelfieSaveBody = { "minimumValidGestures" : vu.face.ui.gestures.getNumOfChallenges(),
                     "validGestures": vu.face.ui.gestures.getNumOfChallenges(),
                     "invalidGestures": 0,
                     "passedTest" : true,
                     "detail" : gestureFeedback}
        ...
        let captureGestureDetailBody = {"gestureCode" : getGestureCode(eventData.challenge),
                                        ...
                                        "minimumScore": vu.face.ui.gestures.getResultsValidatePercentual(),
                                        "validFrames": 0,
                                        "invalidFrames": 0,
                                        "score": vu.sop.challengeType == 'mixed' ?
