...
vu.sop.document.face = vu.sop.document.face || {};

// Initialize function to set camera reference
vu.sop.document.face.initialize = function(camera) {
    moduleCamera = camera;
};
...
vu.sop.document.face.getImg = async function(img) {
    ...
    //cHeight=360
    //cWidth=480
    cHeight=Math.round(moduleCamera.video.videoHeight * 360 / moduleCamera.video.videoWidth)
    cWidth=360
...
export default vu.sop.document.face;